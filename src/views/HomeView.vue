...
<template>
  <div class="container w-full mx-auto mt-2 border-2 border-purple-400">
      ...
      <div class="mx-auto max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          <div class="relative h-64 overflow-hidden rounded-lg sm:h-80 lg:order-last lg:h-full">
            <img
              alt="Desk"
              src="../assets/image/photo-desk.jpg"
              class="absolute inset-0 h-full w-full object-cover"
            />
          </div>

          <div class="lg:py-24">
            <h2 class="text-3xl font-bold sm:text-4xl">Agenda web</h2>

            <p class="mt-4 text-gray-600">
              Tener control total de días de trabajo con días libres con un bonito y sencillo
              calendario Realice cambios de fechas y guarde sus datos de una forma clara y precisa
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div class="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          <div class="relative h-64 overflow-hidden sm:h-80 lg:h-full">
            <img
              alt="Calendar"
              src="../assets/image/photo-calendar.jpg"
              class="absolute inset-0 h-full w-full object-cover"
            />
          </div>
          ...
          <div class="lg:py-16">
            <article class="space-y-4 text-gray-600">
              ...
              <p>
                Diseñar sus periodos de vacaciones sobre un calendario donde tiene acceso a todos
                sus datos
              </p>
            </article>
          </div>
    ...
    <footer aria-label="Site Footer" class="mt-60 bg-gray-100">
